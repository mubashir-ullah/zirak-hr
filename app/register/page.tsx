      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 flex-grow">
        ...
        <div className="max-w-md mx-auto mt-8 mb-16">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl mb-8">
            <h2 className="text-lg font-medium mb-4">I want to register as:</h2>
            <div className="space-y-4">
              <label className="flex items-center space-x-3 p-3 border-2 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800">
                <input
                  type="radio"
                  name="role"
                  value="talent"
              ...
              <label className="flex items-center space-x-3 p-3 border-2 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800">
                <input
                  ...
                  className="h-4 w-4 text-[#d6ff00]"
                />
                <span>I'm a Hiring Manager</span>
              </label>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800"
              >
